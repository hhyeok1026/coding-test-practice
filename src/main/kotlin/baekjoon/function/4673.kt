...
fun main(args: Array<String>) {
    ...
    val keyAndConstructorHashMap = HashMap<Int, Int>()
    ...
    for (i in 1..10000) {
        ...
        while (nowDValue <= 10000) {
            ...
            val generatedValue = generateNextDValue(nowDValue)
            ...
            if(generatedValue <= 10000) {
                ...
                if (!keyAndConstructorHashMap.containsKey(generatedValue)) {
                    keyAndConstructorHashMap[generatedValue] = nowDValue // 만들어진게 key, 만들때 쓴게 생성자
                }
            }
    ...
    /*for ((key, value) in keyAndConstructorHashMap) {
...
fun generateNextDValue(number: Int) : Int {
